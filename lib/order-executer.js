module.exports = function orderExecuter(orderManager, messageEmitter) {

  var stepArguments = {}

  function execute(data, client, callback) {

    var order = orderManager.getOrder(data.order)
      , steps = order.getSteps()
      , emit = messageEmitter.emitOrderMessage.bind(this, client, data.clientId)
      , stepContext =
